...
export const MobileBottomNav: React.FC = () => {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-slate-200 shadow-2xl py-1 px-1.5 safe-area-pb">
      {/* 메뉴 7개를 화면 폭에 똑같이 나눠 담습니다 (칸 수와 버튼 수가 어긋나면 한쪽으로 쏠립니다) */}
      <div className="grid grid-cols-7 gap-0.5 items-center">
        {/* Tab 1: 구장찾기 */}
        <button
          id="m-nav-courses"
          onClick={() => handleTabClick('courses')}
          className={`flex flex-col items-center justify-center py-2 rounded-xl transition-colors cursor-pointer ${
        ...
        >
          ...
          <span className="text-[12px] mt-0.5 font-extrabold whitespace-nowrap leading-none">구장</span>
        </button>
        ...
        >
          ...
          <span className="text-[12px] mt-0.5 font-extrabold whitespace-nowrap leading-none">대회</span>
        </button>
        ...
        <button
          ...
          className={`relative flex flex-col items-center justify-center py-2 rounded-xl transition-colors cursor-pointer ${
        ...
        >
          ...
          <span className="text-[12px] mt-0.5 font-extrabold whitespace-nowrap leading-none">동반자</span>
        ...
        >
          ...
          <span className="text-[12px] mt-0.5 font-extrabold whitespace-nowrap leading-none">리뷰</span>
          {reviews.length > 0 && (
        ...
        >
          ...
          <span className="text-[12px] mt-0.5 font-extrabold whitespace-nowrap leading-none">쿠팡</span>
        </button>
        ...
        >
          ...
          <span className="text-[12px] mt-0.5 font-extrabold whitespace-nowrap leading-none">마당P</span>
        </button>
        ...
        >
          ...
          <span className="text-[12px] mt-0.5 font-extrabold whitespace-nowrap leading-none">맛집</span>
        </button>
      </div>
    </div>
  );
