  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-slate-200 shadow-2xl py-1 px-1 safe-area-pb">
      <div className="grid grid-cols-7 gap-0.5 items-center">
        ...
        >
          <MapPin className={`w-5 h-5 ${activeTab === 'courses' ? 'text-blue-700 stroke-[2.5]' : 'stroke-[1.75]'}`} />
          <span className="text-[10px] mt-0.5 font-bold whitespace-nowrap">구장찾기</span>
        </button>
        ...
        >
          <Trophy className={`w-5 h-5 ${activeTab === 'tournaments' ? 'text-amber-600 stroke-[2.5]' : 'stroke-[1.75]'}`} />
          <span className="text-[10px] mt-0.5 font-bold whitespace-nowrap">대회일정</span>
        </button>
        ...
        >
          <BookOpen className={`w-5 h-5 ${activeTab === 'news' ? 'text-emerald-600 stroke-[2.5]' : 'stroke-[1.75]'}`} />
          <span className="text-[10px] mt-0.5 font-bold whitespace-nowrap">초보가이드</span>
        </button>
        ...
        >
          <Users className={`w-5 h-5 ${activeTab === 'matching' ? 'text-rose-600 stroke-[2.5]' : 'stroke-[1.75]'}`} />
          <span className="text-[10px] mt-0.5 font-bold whitespace-nowrap">동반자</span>
        ...
        >
          <Star className={`w-5 h-5 ${activeTab === 'reviews' ? 'text-amber-500 stroke-[2.5]' : 'stroke-[1.75]'}`} />
          <span className="text-[10px] mt-0.5 font-bold whitespace-nowrap">구장리뷰</span>
          {reviews.length > 0 && (
        ...
        >
          <ShoppingBag className={`w-5 h-5 ${activeTab === 'shop' ? 'text-red-600 stroke-[2.5]' : 'stroke-[1.75]'}`} />
          <span className="text-[10px] mt-0.5 font-bold whitespace-nowrap">추천상품</span>
        </button>
        ...
        >
          <UtensilsCrossed className={`w-5 h-5 ${activeTab === 'restaurants' ? 'text-orange-600 stroke-[2.5]' : 'stroke-[1.75]'}`} />
          <span className="text-[10px] mt-0.5 font-bold whitespace-nowrap">맛집</span>
        </button>
      </div>
    </div>
  );
